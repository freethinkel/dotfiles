...
// Potencially optimized by eliminatin2 conditionals and loops to enhance performance and reduce branching
...
const vec4 TRAIL_COLOR = vec4(1.0, 0.76, 0.87, 0.8);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
// const vec4 TRAIL_COLOR = vec4(0.482, 0.886, 1.0, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.2, 0.2, 0.2, 0.2); // red-orange
