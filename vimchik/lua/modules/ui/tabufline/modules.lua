...
vim.cmd [[
   function! TbKillBuf(bufnr,b,c,d)
        call luaeval('require("core.ui.tabufline").close_buffer(_A)', a:bufnr)
  endfunction]]

vim.cmd "function! TbNewTab(a,b,c,d) \n tabnew \n endfunction"
vim.cmd "function! TbGotoTab(tabnr,b,c,d) \n execute a:tabnr ..'tabnext' \n endfunction"
vim.cmd "function! TbTabClose(a,b,c,d) \n lua require('core.ui.tabufline').closeAllBufs('closeTab') \n endfunction"
vim.cmd "function! TbCloseAllBufs(a,b,c,d) \n lua require('core.ui.tabufline').closeAllBufs() \n endfunction"
...
local function getExplorerWidth()
...
M.CoverNvimTree = function()
  return "%#NvimTreeNormal#" .. (vim.g.nvimtree_side == "right" and "" or string.rep(" ", getExplorerWidth()))
end

M.bufferlist = function()
  local buffers = {} -- buffersults
  local available_space = vim.o.columns - getExplorerWidth() - getBtnsWidth()
...
M.run = function()
  ...
  return (vim.g.explorer_side == "left") and modules.CoverNvimTree() .. result or result .. modules.CoverNvimTree()
end
